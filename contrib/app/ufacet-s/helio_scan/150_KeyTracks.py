...
class KeyTracks():
    ...
    def __init__(self,
        ...
        # Projected.
        print('In KeyTracks.__init__(), reading found key projected corners directory: ', self.input_key_projected_corners_dir)
        ...
        for key_projected_corners_body_ext in key_projected_corners_body_ext_list:
            ...
            if (self.specific_frame_ids is None) or (key_frame_id in self.specific_frame_ids):
                key_corners_dir_body_ext = os.path.join(self.input_key_projected_corners_dir, key_projected_corners_body_ext)
                print('In KeyTracks.__init__(), reading found projected key corners file:      ', key_corners_dir_body_ext)
                ...
                self.key_projected_corners_dict[key_frame_id]['key_projected_corners_body_ext']   = key_projected_corners_body_ext
                self.key_projected_corners_dict[key_frame_id]['key_corners_dir_body_ext']         = key_corners_dir_body_ext
                self.key_projected_corners_dict[key_frame_id]['key_frame_projected_corners_fnxl'] = key_frame_projected_corners_fnxl
        ...
        # Confirmed.
        print('In KeyTracks.__init__(), reading found key confirmed corners directory: ', self.input_key_confirmed_corners_dir)
        ...
        for key_confirmed_corners_body_ext in key_confirmed_corners_body_ext_list:
            ...
            key_frame_id     = upf.frame_id_given_frame_id_str(key_frame_id_str)
            if (self.specific_frame_ids is None) or (key_frame_id in self.specific_frame_ids):
                key_corners_dir_body_ext = os.path.join(self.input_key_confirmed_corners_dir, key_confirmed_corners_body_ext)
                print('In KeyTracks.__init__(), reading found confirmed key corners file:      ', key_corners_dir_body_ext)
                ...
                self.key_confirmed_corners_dict[key_frame_id]['key_confirmed_corners_body_ext']   = key_confirmed_corners_body_ext
                self.key_confirmed_corners_dict[key_frame_id]['key_corners_dir_body_ext']         = key_corners_dir_body_ext
                self.key_confirmed_corners_dict[key_frame_id]['key_frame_confirmed_corners_fnxl'] = key_frame_confirmed_corners_fnxl
        # Confirm what was read.
    ...
    def find_and_save_key_tracks(self):
        ...
        if self.force_construction or (not ft.directory_exists(self.output_data_dir)) or ft.directory_is_empty(self.output_data_dir):
            ...
            key_frame_ids_to_process = dt.sorted_keys(self.key_projected_corners_dict)  # Already pruned to key frame ids of interest.
            ...
            print('In KeyTracks.search_key_tracks(), key frame corner tracking done.  len(list_of_result_dicts) =', len(list_of_result_dicts))
            ...
            for result_dict in list_of_result_dicts:
                ...
                print('    ' + str(key_frame_id) + ':')  # Using "str(key_frame_id)" is okay, because we don't want leading zeros.
    ...
    def search_key_track(self, key_frame_id):
        ...
        try:
            ...
            key_frame_projected_corners_fnxl = self.key_projected_corners_dict[key_frame_id]['key_frame_projected_corners_fnxl']
            key_frame_confirmed_corners_fnxl = self.key_confirmed_corners_dict[key_frame_id]['key_frame_confirmed_corners_fnxl']
            ...
            # Execute search.
            logt.info(local_logger, 'In KeyTracks.search_key_track_aux(), searching for corners in key_frame_id='+str(key_frame_id)+'...')
            ...
            logt.info(local_logger, 'In KeyTracks.search_key_track_aux(), corners done key_frame_id='+str(key_frame_id)+'.')
        except:
            error_type, error_instance, traceback = sys.exc_info()
            logt.log_and_raise_value_error(local_logger, 'In KeyTracks.search_key_track(), Key Frame 1 Processing Exception: ' + str(error_instance.args[0]))
    ...
    def save_key_tracks(self, list_of_result_dicts):
        ...
        for result_dict in list_of_result_dicts:
            ...
            # Projected.
            key_frame_projected_track_fnxl = result_dict['key_frame_projected_track_fnxl']
            key_frame_projected_track_body_ext = self.input_video_body + '_' + key_frame_id_str + '_projected_tracks_fnxl.csv'
            key_frame_projected_track_dir_body_ext = os.path.join(self.key_frame_projected_tracks_dir, key_frame_projected_track_body_ext)
            print('In KeyTracks.save_key_tracks(), writing found projected key frame track: ', key_frame_projected_track_dir_body_ext)
            key_frame_projected_track_fnxl.save(key_frame_projected_track_dir_body_ext)
            # Confirmed.
            key_frame_confirmed_track_fnxl = result_dict['key_frame_confirmed_track_fnxl']
            key_frame_confirmed_track_body_ext = self.input_video_body + '_' + key_frame_id_str + '_confirmed_tracks_fnxl.csv'
            key_frame_confirmed_track_dir_body_ext = os.path.join(self.key_frame_confirmed_tracks_dir, key_frame_confirmed_track_body_ext)
            print('In KeyTracks.save_key_tracks(), writing found confirmed key frame track: ', key_frame_confirmed_track_dir_body_ext)
    ...
    def save_data(self, list_of_result_dicts):
        ...
        print('In KeyTracks.save_data(), writing tracked_frames per key frame:', os.path.join(self.output_data_dir, self.tfpkf_body_ext))
    ...
    def read_key_tracks(self):
        # Projected.
        print('In KeyTracks.read_key_tracks(), reading found key frame projected tracks directory: ', self.key_frame_projected_tracks_dir)
        ...
        for key_frame_projected_track_body_ext in key_frame_projected_track_body_ext_list:
            ...
            print('In KeyTracks.read_key_tracks(), reading found key frame projected track:        ', key_frame_projected_track_dir_body_ext)
        ...
        # Confirmed.
        print('In KeyTracks.read_key_tracks(), reading found key frame confirmed tracks directory: ', self.key_frame_confirmed_tracks_dir)
        ...
        for key_frame_confirmed_track_body_ext in key_frame_confirmed_track_body_ext_list:
            ...
            print('In KeyTracks.read_key_tracks(), reading found key frame confirmed track:        ', key_frame_confirmed_track_dir_body_ext)
...
# log_dir_body_ext                = experiment_dir() + '2020-12-03_FastScan1/3_Post/Answers/20201203/1544_NS_U/Small_150_KeyTracks/mavic_zoom/log/KeyTracks_log.txt'
    log_dir_body_ext                = experiment_dir() + '2020-12-03_FastScan1/3_Post/Answers/20201203/1544_NS_U/150_KeyTracks/mavic_zoom/log/KeyTracks_log.txt'
    # Input/output sources.
    input_video_dir_body_ext        = experiment_dir() + '2020-12-03_FastScan1/2_Data/20201203/1544_NS_U/mavic_zoom/DJI_427t_428_429.MP4'
    input_key_projected_corners_dir = experiment_dir() + '2020-12-03_FastScan1/3_Post/Answers/20201203/1544_NS_U/140_KeyCorners/mavic_zoom/data/key_corners/'  # ?? SCAFFOLDING RCB -- BUG: USING PROJECTED CORNERS FOR BOTH PROJECTED AND CONFIRMED.
    input_key_confirmed_corners_dir = experiment_dir() + '2020-12-03_FastScan1/3_Post/Answers/20201203/1544_NS_U/140_KeyCorners/mavic_zoom/data/key_corners/'  # ?? SCAFFOLDING RCB -- BUG: USING PROJECTED CORNERS FOR BOTH PROJECTED AND CONFIRMED.
...
# output_construction_dir         = experiment_dir() + '2020-12-03_FastScan1/3_Post/Construction/20201203/1544_NS_U/Small_150c_KeyTracks/mavic_zoom/'
    output_data_dir                 = experiment_dir() + '2020-12-03_FastScan1/3_Post/Answers/20201203/1544_NS_U/150_KeyTracks/mavic_zoom/data/'
    output_render_dir               = experiment_dir() + '2020-12-03_FastScan1/3_Post/Answers/20201203/1544_NS_U/150_KeyTracks/mavic_zoom/render/'
    output_construction_dir         = experiment_dir() + '2020-12-03_FastScan1/3_Post/Construction/20201203/1544_NS_U/150c_KeyTracks/mavic_zoom/'
    # Render control.
