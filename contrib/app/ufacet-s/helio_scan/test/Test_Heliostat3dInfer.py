...
class Test_Heliostat3dInfer():
    ...
    def __init__(self,
        ...
        self.heliostat_theoretical = uh3a.read_txt_file_to_heliostat(self.theoretical_heliostat_dir_body_ext, self.specifications)


    def execute_infer_3d(self, input_corner_2d_trajectories_file):
        hel_name = self.heliostat_name_given_heliostat_2d_corner_trajectories_dir_body_ext(input_corner_2d_trajectories_file)
        ...
        print('In Test_Heliostat3dInfer.execute_infer_3d(), executable_output_dir_body_ext = ' + executable_output_dir_body_ext)
...
# self.call_executable(file)
        ...
        executable_output_body_ext = hel_name + '_reconstructed.txt'
        executable_output_dir_body_ext = os.path.join(self.output_heliostat_3d_dir, executable_output_body_ext)
        heliostat_3d_dir_body_ext      = os.path.join(self.output_heliostat_3d_dir, hel_name + '_' + self.confirm_distort_str + '_corners_3d.txt')
        ...
        uh3a.generate_plots(heliostat_3d_dir_body_ext, output_evaluation_plot_dir, self.specifications, self.heliostat_theoretical)
...
#         proc.wait()
    ...
    def perform_3d_inference(self, single_execution=True):
        ...
        output_evaluation_csv_dir_2 = self.output_evaluation_csv_dir + '/'  # ?? SCAFFOLDING RCB -- MAKE THIS PLATFORM INDEPENDENT.
        uh3a.generate_csv(heliostat_3d_dir_body_ext_list, output_evaluation_csv_dir_2, self.specifications, self.heliostat_theoretical)
        print('In Test_Heliostat3dInfer.perform_3d_inference() csv files finished.')


    def heliostat_name_given_heliostat_2d_corner_trajectories_dir_body_ext(self, heliostat_2d_corner_trajectories_dir_body_ext):  # ?? SCAFFOLDING RCB -- MAKE THIS GENERAL, CORRECT, ERROR-CHECKING.  (IT'S LATE, AND I'M OUT OF TIME.)
        heliostat_2d_corner_trajectories_dir, heliostat_2d_corner_trajectories_body, heliostat_2d_corner_trajectories_ext = ft.path_components(heliostat_2d_corner_trajectories_dir_body_ext)
...
if __name__ == "__main__":
    executable_path                    = home_dir() + 'Code/ufacet_code/Test_Heliostat3dInfer/bin/reconstruct_main.out'  # ?? SCAFFOLDING RCB -- RE-EVALUATE THIS.  PASS IN?
...
# theoretical_heliostat_dir_body_ext = experiment_dir() + '2020-12-03_FastScan1/3_Post/Answers/20201203/1544_NS_U/010_HeliostatModel/data/NSTTF_Facet_Corners.csv'  # ?? SCAFFOLDING RCB -- MOVE THIS INTO TEST DATA.
    ...
    # 01_Study_5W1
    confirm_distort_str                = 'confirmed_undistorted'
    input_heliostat_2d_corners_dir     = experiment_dir() + '2020-12-03_FastScan1/9_Analysis/2021-10-02_Study_Heliostat3dInfer/01_Study_5W1_solo/input_merged_tracks/'
    output_heliostat_3d_dir            = experiment_dir() + '2020-12-03_FastScan1/9_Analysis/2021-10-02_Study_Heliostat3dInfer/01_Study_5W1_solo/output_reconstructed_heliostats/'
    output_evaluation_plot_dir         = experiment_dir() + '2020-12-03_FastScan1/9_Analysis/2021-10-02_Study_Heliostat3dInfer/01_Study_5W1_solo/output_evaluation_plots/'
    output_evaluation_csv_dir          = experiment_dir() + '2020-12-03_FastScan1/9_Analysis/2021-10-02_Study_Heliostat3dInfer/01_Study_5W1_solo/output_evaluation_csv_files/'
    cam_matrix                         = utils.CameraMatrix  # ?? SCAFFOLDING RCB -- RE-EVALUATE THIS
    heliostat_3d_file_suffix           = '_' + confirm_distort_str + '_corner_2d_trajectories.txt'
    theoretical_heliostat_dir_body_ext = experiment_dir() + '2020-12-03_FastScan1/3_Post/Answers/20201203/1544_NS_U/010_HeliostatModel/data/NSTTF_Facet_Corners.csv'  # ?? SCAFFOLDING RCB -- MOVE THIS INTO TEST DATA.
...
# theoretical_heliostat_dir_body_ext = experiment_dir() + '2020-12-03_FastScan1/3_Post/Answers/20201203/1544_NS_U/010_HeliostatModel/data/NSTTF_Facet_Corners.csv'  # ?? SCAFFOLDING RCB -- MOVE THIS INTO TEST DATA.
    ...
    rec = Test_Heliostat3dInfer(executable_path,
                      confirm_distort_str,
