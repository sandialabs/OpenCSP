...
if __name__ == "__main__":
    executable_path = home_dir() + 'Code/ufacet_code/Reconstruct/bin/reconstruct_main.out'  # ?? SCAFFOLDING RCB -- RE-EVALUATE THIS.  PASS IN?
...
# theoretical_heliostat_dir_body_ext = experiment_dir() + '2020-12-03_FastScan1/3_Post/Answers/20201203/1544_NS_U/010_HeliostatModel/data/NSTTF_Facet_Corners.csv'  # ?? SCAFFOLDING RCB -- MOVE THIS INTO TEST DATA.
    ...
    confirm_distort_str = 'confirmed_undistorted'
    input_heliostat_2d_corners_dir = experiment_dir() + '2020-12-03_FastScan1/9_Analysis/2021-09-21_ReconstructionStudy/02_Study_5W1_9E9_11W1_14E3_solo/input_merged_tracks/'
    output_heliostat_3d_dir = experiment_dir() + '2020-12-03_FastScan1/9_Analysis/2021-09-21_ReconstructionStudy/02_Study_5W1_9E9_11W1_14E3_solo/output_reconstructed_heliostats/'
    output_evaluation_plot_dir = experiment_dir() + '2020-12-03_FastScan1/9_Analysis/2021-09-21_ReconstructionStudy/02_Study_5W1_9E9_11W1_14E3_solo/output_evaluation_plots/'
    output_evaluation_csv_dir = experiment_dir() + '2020-12-03_FastScan1/9_Analysis/2021-09-21_ReconstructionStudy/02_Study_5W1_9E9_11W1_14E3_solo/output_evaluation_csv_files/'
    cam_matrix = utils.CameraMatrix  # ?? SCAFFOLDING RCB -- RE-EVALUATE THIS
    heliostat_3d_file_suffix = '_' + confirm_distort_str + '_corner_2d_trajectories.txt'
    theoretical_heliostat_dir_body_ext = experiment_dir() + '2020-12-03_FastScan1/3_Post/Answers/20201203/1544_NS_U/010_HeliostatModel/data/NSTTF_Facet_Corners.csv'  # ?? SCAFFOLDING RCB -- MOVE THIS INTO TEST DATA.
    
    rec = Reconstruct(executable_path,
                      confirm_distort_str,
