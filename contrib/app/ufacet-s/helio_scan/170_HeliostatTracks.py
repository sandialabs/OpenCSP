...
class HeliostatTracks():
    ...
    def __init__(self,
                 ...
                 render_control_confirmed):                 # Flags to control rendering on this run, for the confirmed data.
        ...
        self.heliostat_projected_tracks_dir_body_ext = os.path.join(self.output_data_dir, self.heliostat_projected_tracks_body_ext)
        # Confirmed.
        ...
        self.heliostat_confirmed_tracks_dir_body_ext = os.path.join(self.output_data_dir, self.heliostat_confirmed_tracks_body_ext)

        # Output directories for heliostat corner tracks files.
        self.output_heliostat_projected_corner_tracks_dir = os.path.join(self.output_data_dir, 'projected_corner_tracks')
        self.output_heliostat_confirmed_corner_tracks_dir = os.path.join(self.output_data_dir, 'confirmed_corner_tracks')
        self.output_heliostat_undistorted_projected_corner_tracks_dir = os.path.join(self.output_data_dir, 'undistorted_projected_corner_tracks')
        self.output_heliostat_undistorted_confirmed_corner_tracks_dir = os.path.join(self.output_data_dir, 'undistorted_confirmed_corner_tracks')
        ...
        # Projected.
        print('In HeliostatTracks.__init__(), reading projected video tracks file: ', self.input_video_projected_tracks_dir_body_ext)
        ...
        self.video_projected_tracks_fnxl.print(max_keys=12,
                                               max_value_length=200,
                                               indent=4)
        # Confirmed.
        print('In HeliostatTracks.__init__(), reading confirmed video tracks file: ', self.input_video_confirmed_tracks_dir_body_ext)
        ...
        self.video_confirmed_tracks_fnxl.print(max_keys=12,
                                               max_value_length=200,
                                               indent=4)
    ...
    def construct_and_save_heliostat_tracks_aux(self, video_tracks_fnxl, projected_or_confirmed_str):
        print('In HeliostatTracks.construct_and_save_heliostat_tracks_aux(), constructing ' + projected_or_confirmed_str + ' heliostat tracks...')
    ...
    def save_heliostat_tracks(self, heliostat_tracks_nfxl, projected_or_confirmed_str):
        ...
        if projected_or_confirmed_str == 'projected':
            ...
            msg = 'In HeliostatTracks.save_heliostat_tracks(), encountered projected_or_confirmed_str="'+str(projected_or_confirmed_str)+'" which was neither "projected" or "confirmed".'
            print('ERROR: ' + msg)
            raise ValueError(msg)
        print('In HeliostatTracks.save_heliostat_tracks(), writing heliostat track file: ', heliostat_tracks_dir_body_ext)
    ...
    def save_data(self, heliostat_tracks_nfxl, projected_or_confirmed_str):
        ...
        if projected_or_confirmed_str == 'projected':
            ...
            msg = 'In HeliostatTracks.save_data(), encountered projected_or_confirmed_str="'+str(projected_or_confirmed_str)+'" which was neither "projected" or "confirmed".'
            print('ERROR: ' + msg)
            raise ValueError(msg)
        # Statistics.
        summary_dict = {}
        summary_dict['n_heliostat_track_frames'] = heliostat_tracks_nfxl.number_of_frames()
        print('In HeliostatTracks.save_data(), writing key frame ' + projected_or_confirmed_str + ' summary statistics...')
        ft.write_dict_file('heliostat ' + projected_or_confirmed_str + ' tracks summary statistics', self.output_data_dir, dict_body, summary_dict)
        # Video frames per heliostat.
        video_frames_per_heliostat_dict = heliostat_tracks_nfxl.frames_per_heliostat()
        print('In HeliostatTracks.save_data(), writing video frames per ' + projected_or_confirmed_str + ' heliostat:', os.path.join(self.output_data_dir, vfph_body_ext))
    ...
    def read_heliostat_tracks(self):
        # Projected.
        print('In HeliostatTracks.read_heliostat_tracks(), reading heliostat projected tracks file: ', self.heliostat_projected_tracks_dir_body_ext)
        ...
        # Confirmed.
        print('In HeliostatTracks.read_heliostat_tracks(), reading heliostat confirmed tracks file: ', self.heliostat_confirmed_tracks_dir_body_ext)
    ...
    def render(self):
        print('In HeliostatTracks.render(), self.output_construction_projected_dir=', self.output_construction_projected_dir)  # ?? SCAFFOLDING RCB -- TEMPORARY
        print('In HeliostatTracks.render(), self.output_construction_confirmed_dir=', self.output_construction_confirmed_dir)  # ?? SCAFFOLDING RCB -- TEMPORARY
        # Projected.
        if self.render_control_projected.draw_heliostat_tracks and self.generated_heliostat_projected_tracks:  # Don't render unless we generated.
            self.render_aux(self.heliostat_projected_tracks_nfxl, self.output_construction_projected_dir, self.render_control_projected, 'projected')
        # Confirmed.
        if self.render_control_confirmed.draw_heliostat_tracks and self.generated_heliostat_confirmed_tracks:  # Don't render unless we generated.
            self.render_aux(self.heliostat_confirmed_tracks_nfxl, self.output_construction_confirmed_dir, self.render_control_confirmed, 'confirmed')
    ...
    def render_aux(self, heliostat_tracks_nfxl, output_construction_dir, render_control, projected_or_confirmed_str):
        ...
        print('In HeliostatTracks.render_aux(), output_construction_dir=', output_construction_dir)  # ?? SCAFFOLDING RCB -- TEMPORARY
...
#specific_frame_ids                 = [3896,4569,5417,6076]  # Heliostats 11W6, 11W7, and 11W8 are seen in multiple passes.
    ...
    log_dir_body_ext                          = experiment_dir() + '2020-12-03_FastScan1/3_Post/Answers/20201203/1544_NS_U/Small_170_HeliostatTracks/mavic_zoom/log/HeliostatTracks_log.txt'
    # Input/output sources.
    input_video_dir_body_ext                  = experiment_dir() + '2020-12-03_FastScan1/2_Data/20201203/1544_NS_U/mavic_zoom/DJI_427t_428_429.MP4'
    input_video_projected_tracks_dir_body_ext = experiment_dir() + '2020-12-03_FastScan1/3_Post/Answers/20201203/1544_NS_U/Small_160_VideoTracks/mavic_zoom/data/DJI_427t_428_429_video_projected_tracks_fnxl.csv'
    input_video_confirmed_tracks_dir_body_ext = experiment_dir() + '2020-12-03_FastScan1/3_Post/Answers/20201203/1544_NS_U/Small_160_VideoTracks/mavic_zoom/data/DJI_427t_428_429_video_confirmed_tracks_fnxl.csv'
    ...
    output_data_dir                           = experiment_dir() + '2020-12-03_FastScan1/3_Post/Answers/20201203/1544_NS_U/Small_170_HeliostatTracks/mavic_zoom/data/'
    output_render_dir                         = experiment_dir() + '2020-12-03_FastScan1/3_Post/Answers/20201203/1544_NS_U/Small_170_HeliostatTracks/mavic_zoom/render/'
    output_construction_dir                   = experiment_dir() + '2020-12-03_FastScan1/3_Post/Construction/20201203/1544_NS_U/Small_170c_HeliostatTracks/mavic_zoom/'
