...
class ExtractedFrames():
    ...
    def extract_frames_and_write_data(self):
        ...
        if ft.directory_is_empty(self.output_frame_dir):
            ...
            # Extract the frames.
            n_frames = vm.extract_frames(self.input_video_dir_body_ext, self.output_frame_dir, self.output_frame_id_format)
            ...
            ft.write_dict_file('frame summary statistics (possibly includes duplicates)', self.output_data_dir, self.dict_body, summary_dict)
...
if __name__ == "__main__":
    ...
    output_data_dir          = experiment_dir() + '2020-12-03_FastScan1/3_Post/Answers/20201203/1544_NS_U/070_ExtractedFrames/mavic_zoom/data/'
    output_render_dir        = experiment_dir() + '2020-12-03_FastScan1/3_Post/Answers/20201203/1544_NS_U/070_ExtractedFrames/mavic_zoom/render/'
    output_frame_dir         = experiment_dir() + '2020-12-03_FastScan1/3_Post/Construction/20201203/1544_NS_U/070c_ExtractedFrames/mavic_zoom/frames/'
    output_frame_id_format   = '.%06d'
    render_control = rcef.default()

    extracted_frames_object = ExtractedFrames(input_video_dir_body_ext,
                                              output_data_dir,
                                              output_render_dir,
                                              output_frame_dir,
