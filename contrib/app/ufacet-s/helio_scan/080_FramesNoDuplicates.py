...
class FramesNoDuplicates():
    ...
    def filter_frames_and_write_data(self):
        ...
        if ft.directory_is_empty(self.output_frame_dir):
            ...
            non_duplicate_frame_files, duplicate_frame_files = vm.identify_duplicate_frames(self.input_frame_dir, self.output_frame_dir,
                                                                                            self.tolerance_image_size, self.tolerance_image_pixel)

            # Copy non-duplicate frames to frame output directory.
            for frame_file in non_duplicate_frame_files:
                print('In FramesNoDuplicates.filter_frames_and_write_data(), copying frame: ' + frame_file + '  to  ' + output_frame_dir)
            ...
            ft.write_dict_file('frame summary statistics (duplicates removed)', self.output_data_dir, self.dict_body, summary_dict)
            ft.write_text_file('non-duplicate frames', self.output_data_dir, self.non_duplicate_body, non_duplicate_frame_files)
    ...
    def draw_example_frames(self):
        ...
        upf.draw_example_frames(self.output_frame_dir,
...
if __name__ == "__main__":
    ...
    input_frame_dir          = experiment_dir() + '2020-12-03_FastScan1/3_Post/Construction/20201203/1544_NS_U/070c_ExtractedFrames/mavic_zoom/frames/'
    output_data_dir          = experiment_dir() + '2020-12-03_FastScan1/3_Post/Answers/20201203/1544_NS_U/080_FramesNoDuplicates/mavic_zoom/data/'
    output_render_dir        = experiment_dir() + '2020-12-03_FastScan1/3_Post/Answers/20201203/1544_NS_U/080_FramesNoDuplicates/mavic_zoom/render/'
    output_frame_dir         = experiment_dir() + '2020-12-03_FastScan1/3_Post/Construction/20201203/1544_NS_U/080c_FramesNoDuplicates/mavic_zoom/frames/'
    tolerance_image_size     = 0
    tolerance_image_pixel    = 0
    render_control           = rcfnd.default()

    extracted_frames_object = FramesNoDuplicates(input_video_dir_body_ext,
                                                 input_frame_dir,
                                                 output_data_dir,
                                                 output_render_dir,
                                                 output_frame_dir,
