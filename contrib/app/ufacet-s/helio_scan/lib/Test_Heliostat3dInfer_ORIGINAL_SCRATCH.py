...
class Heliostat3dInfer():
    ...
    def PredictConfirm(self, tracking_direction): 
        ...
        if tracking_direction == 'forward':
            ...
            raise ValueError('ERROR: In Heliostat3dInfer.PredictConfirm(), unexpected tracking_direction="'+str(tracking_direction)+'" encountered(1).  Allowable values are "forward" and "backward" only (2).')
    ...
    def draw_frame_with_points_if_desired_aux(self, img, frame_id_str, list_of_name_xy_lists, Confirmed_or_Projected_str, point_color):
        if self.draw_track_images:
            ...
            if Confirmed_or_Projected_str == 'Projected':
                ...
                msg = 'In Heliostat3dInfer.draw_frame_with_points(), encountered unexpected Confirmed_or_Projected_str = ' + str(Confirmed_or_Projected_str)
                print(msg)
                raise ValueError(msg)
