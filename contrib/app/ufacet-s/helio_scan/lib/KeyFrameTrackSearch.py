...
class KeyFrameTrackSearch:
    ...
    def __init__(
        ...
        canny_levels: list[
            str
        ],  # inner loop canny levels used during corner confirmation iteration, eg ['medium', 'light']
    ...
    def draw_frame_with_points_if_desired_aux(
        ...
        if self.draw_track_images:
            ...
            if Confirmed_or_Projected_str == "Projected":
                ...
                msg = (
                    "In KeyFrameTrackSearch.draw_frame_with_points(), encountered unexpected Confirmed_or_Projected_str = "
