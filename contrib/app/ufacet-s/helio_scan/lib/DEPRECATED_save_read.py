    ...
    with open(output_file, "w") as f:
        ...
        for facet in facets:
            ...
            for corner in corners:
                ...
                key2 = 'edge_pixels'
                key3 = 'edge_points'
                corners_type = corner['corner_type']  # ?? SCAFFOLDING RCB -- INSERTED THIS LINE BLINDLY WITHOUT THOROUGH STUDY, TO ELIMINATE COMPILER WARNING.
                if corners_type == 'top_left':
                    prefix1 = 'left_'
                    prefix2 = 'top_'
                elif corners_type == 'top_right':
...
def centers3d_to_corners3d(facet_centers, facet_width, facet_height):
    ...
    corner_offsets = np.array([[-width/2,   height/2,   0],
                                [width/2,    height/2,   0],
                                [width/2,    -height/2,  0],
                                [-width/2,   -height/2,  0]])
