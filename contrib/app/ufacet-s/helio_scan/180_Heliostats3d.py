...
#self.reconstruct_executable_path                   = '<home_dir>/Code/ufacet_code/Reconstruct/bin/reconstruct_main.out'  # ?? SCAFFOLDING RCB -- RE-EVALUATE THIS.  PASS IN?
        ...
        self.theoretical_flat_heliostat_dict               = uh3a.read_txt_file_to_heliostat(self.theoretical_flat_heliostat_dir_body_ext, self.specifications)
        self.theoretical_flat_heliostat_xyz_list           = uh3a.heliostat_xyz_list_given_dict(self.theoretical_flat_heliostat_dict)
...
# self.output_heliostat_confirmed_undistorted_corner_2d_trajectories_dir = os.path.join(self.output_data_dir, 'confirmed_undistorted_corner_2d_trajectories')
        ...
        # Flat.
        self.theoretical_flat_heliostat_dir_body_ext = self.save_and_analyze_flat_heliostat(self.specifications.heliostat_design_name)
        # Nearest.
        self.nearest_smooth_dir_body_ext,  \
        self.nearest_design_dir_body_ext = self.construct_save_and_analyze_key_heliostats(self.specifications.heliostat_design_name, 'Nearest')
        # Farthest.
        self.farthest_smooth_dir_body_ext,  \
        self.farthest_design_dir_body_ext = self.construct_save_and_analyze_key_heliostats(self.specifications.heliostat_design_name, 'Farthest')
        ...
        # Projected.
        self.output_heliostat_projected_distorted_corners_3d_dir   = os.path.join(self.output_data_dir, 'projected_distorted_corners_3d')
        self.output_heliostat_projected_undistorted_corners_3d_dir = os.path.join(self.output_data_dir, 'projected_undistorted_corners_3d')
        # Confirmed.
        self.output_heliostat_confirmed_distorted_corners_3d_dir   = os.path.join(self.output_data_dir, 'confirmed_distorted_corners_3d')
        self.output_heliostat_confirmed_undistorted_corners_3d_dir = os.path.join(self.output_data_dir, 'confirmed_undistorted_corners_3d')

        # Output heliostat 3-d cnstruction directories.
        # Projected.
        self.output_heliostat_projected_distorted_construct_corners_3d_dir   = os.path.join(self.output_construction_dir, 'projected_distorted_corners_3dc')
        self.output_heliostat_projected_undistorted_construct_corners_3d_dir = os.path.join(self.output_construction_dir, 'projected_undistorted_corners_3dc')
        # Confirmed.
        self.output_heliostat_confirmed_distorted_construct_corners_3d_dir   = os.path.join(self.output_construction_dir, 'confirmed_distorted_corners_3dc')
        self.output_heliostat_confirmed_undistorted_construct_corners_3d_dir = os.path.join(self.output_construction_dir, 'confirmed_undistorted_corners_3dc')
...
# self.heliostat_projected_tracks_nfxl.print(max_keys=12, max_value_length=200, indent=4)  # SCAFFOLDING RCB -- TEMPORARILY DISABLED. ****
        # Confirmed.
        print('In Heliostats3d.__init__(), reading heliostat confirmed tracks file: ', self.input_heliostat_confirmed_tracks_dir_body_ext)
    ...
    def save_and_analyze_flat_heliostat(self, heliostat_design_name):
        ...
        uh3a.analyze_and_render_heliostat_3d(flat_dir_body_ext, flat_dir_body_ext, None, self.specifications, flat_output_dir,
    ...
    def construct_save_and_analyze_key_heliostats(self, heliostat_design_name, key_name):
        ...
        if key_name == 'Nearest':
            ...
            print('ERROR: In Heliostats3d.construct_save_and_analyze_key_heliostats(), unexpected key_name="'+str(key_name)+'" encountered (1).')
            assert False
        ...
        # Analyze.
        camera_rvec = np.array([-2.68359887, -0.2037837, 0.215282]).reshape(3, 1)     # See save_and_analyze_flat_heliostat() for background.
        camera_tvec = np.array([ 5.13947086, -2.22502302, 25.35294025]).reshape(3, 1) #
        uh3a.analyze_and_render_heliostat_3d(self.theoretical_flat_heliostat_dir_body_ext, smooth_dir_body_ext, None, self.specifications, smooth_output_dir,
                                             camera_rvec=camera_rvec, camera_tvec=camera_tvec, camera_matrix=self.camera_matrix, distortion_coefficients=self.zero_distortion_coefficients)
        ...
        camera_rvec = np.array([-2.68359887, -0.2037837, 0.215282]).reshape(3, 1)     # See save_and_analyze_flat_heliostat() for background.
        camera_tvec = np.array([ 5.13947086, -2.22502302, 25.35294025]).reshape(3, 1) #
        uh3a.analyze_and_render_heliostat_3d(self.theoretical_flat_heliostat_dir_body_ext, design_dir_body_ext, None, self.specifications, design_output_dir,
                                             camera_rvec=camera_rvec, camera_tvec=camera_tvec, camera_matrix=self.camera_matrix, distortion_coefficients=self.zero_distortion_coefficients)
    ...
    def construct_save_and_analyze_demonstration_heliostat_corner_xyz_list(self):
        ...
        demonstration_heliostat_corner_xyz_list = self.specifications.heliostat_corner_xyz_list_given_heliostat_spec(demonstration_heliostat_spec)
        # Save.
        output_hel_name = 'Demonstration'
        output_hel_dir = os.path.join(self.output_ideal_model_dir, output_hel_name)
        output_hel_dir_body_ext = uh3a.save_heliostat_3d(output_hel_name, demonstration_heliostat_corner_xyz_list, output_hel_dir)
        # Analyze.
        camera_rvec = np.array([-2.68359887, -0.2037837, 0.215282]).reshape(3, 1)     # See Heliostats3d.save_and_analyze_flat_heliostat() for background.
        camera_tvec = np.array([ 5.13947086, -2.22502302, 25.35294025]).reshape(3, 1) #
...
#                                                              self.render_control_confirmed_distorted)
            self.construct_and_save_heliostat_corners_3d_aux(self.heliostat_confirmed_tracks_nfxl, 'confirmed', 'undistorted',
#self.output_heliostat_confirmed_undistorted_corner_2d_trajectories_dir, 
    ...
    def construct_and_save_heliostat_corners_3d_aux(self,
...
# output_corner_2d_trajectories_dir,
                                                    ...
                                                    render_control):
        print('\nIn Heliostats3d.construct_and_save_heliostat_corners_3d_aux(), reconstructing ' + projected_or_confirmed_str + ' ' + distorted_or_undistorted_str + ' case...')
...
# infer_dict['output_corner_2d_trajectories_dir'] = output_corner_2d_trajectories_dir
        ...
        if self.single_processor:
            print('In Heliostats3d.construct_and_save_heliostat_corners_3d_aux(), starting heliostat 3-d inference (single processor)...')
            ...
            print('In Heliostats3d.construct_and_save_heliostat_corners_3d_aux(), starting heliostat 3-d inference (multi-processor)...')
        ...
        for hi3d in list_of_result_hi3ds:
            if hi3d is not None:  # We might have skipped some heliostats, for example for debuggging.
                # Output file name.
                output_corners_3d_dir_body_ext = uh3a.corners_3d_dir_body_ext(self.input_video_body, hi3d.hel_name, projected_or_confirmed_str, distorted_or_undistorted_str, output_corners_3d_dir)
...
# dt.print_dict(corner_trajectory_dict, indent=4)  # ?? SCAFFOLDING RCB -- TEMPORARY
        ...
        if distorted_or_undistorted_str == 'distorted':
            ...
            list_of_frame_id_xy_lists_to_process = [[frame_id_xy_list[0], self.undistort_xy_list(frame_id_xy_list[1])] for frame_id_xy_list in list_of_frame_id_xy_lists]
        else:
            msg = 'In Heliostats3d.execute_heliostat_3d_inference(), encountered distorted_or_undistorted_str="'+str(distorted_or_undistorted_str)+'" which was neither "distorted" or "undistorted".'
            print('ERROR: ' + msg)
            raise ValueError(msg)

        # Construct the 3-d inference for this heliostat.
        result_hi3d = hi3d.HeliostatInfer3d(hel_name,
...
#     return corner_trajectory_dict
    ...
    def undistort_xy_list(self, input_xy_list):
        ...
        undistorted_xy_array = cv.undistortPoints(xy_array, self.camera_matrix, self.distortion_coefficients, None, camera_matrix_2)
...
if __name__ == "__main__":
    ...
    log_dir_body_ext                          = experiment_dir() + '2020-12-03_FastScan1/3_Post/Answers/20201203/1544_NS_U/180_Heliostats3d/mavic_zoom/log/Heliostats3d_log.txt'
    # Input/output sources.
    specifications                            = Dspec.nsttf_specifications()  # Solar field parameters.
    theoretical_flat_heliostat_dir_body_ext   = experiment_dir() + '2020-12-03_FastScan1/3_Post/Answers/20201203/1544_NS_U/010_HeliostatModel/data/NSTTF_Facet_Corners.csv'
    input_video_dir_body_ext                  = experiment_dir() + '2020-12-03_FastScan1/2_Data/20201203/1544_NS_U/mavic_zoom/DJI_427t_428_429.MP4'
    input_frame_dir                           = experiment_dir() + '2020-12-03_FastScan1/3_Post/Construction/20201203/1544_NS_U/080c_FramesNoDuplicates/mavic_zoom/frames/'
    input_frame_id_format                     = '06d' # Note different from format used in ffmpeg call, which is '.%06d'
    input_video_projected_tracks_dir_body_ext = experiment_dir() + '2020-12-03_FastScan1/3_Post/Answers/20201203/1544_NS_U/170_HeliostatTracks/mavic_zoom/data/DJI_427t_428_429_heliostat_projected_tracks_nfxl.csv'
    input_video_confirmed_tracks_dir_body_ext = experiment_dir() + '2020-12-03_FastScan1/3_Post/Answers/20201203/1544_NS_U/170_HeliostatTracks/mavic_zoom/data/DJI_427t_428_429_heliostat_confirmed_tracks_nfxl.csv'
    output_data_dir                           = experiment_dir() + '2020-12-03_FastScan1/3_Post/Answers/20201203/1544_NS_U/180_Heliostats3d/mavic_zoom/data/'
    output_render_dir                         = experiment_dir() + '2020-12-03_FastScan1/3_Post/Answers/20201203/1544_NS_U/180_Heliostats3d/mavic_zoom/render/'
    output_construction_dir                   = experiment_dir() + '2020-12-03_FastScan1/3_Post/Construction/20201203/1544_NS_U/180c_Heliostats3d/mavic_zoom/'
