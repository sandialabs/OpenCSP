...
class UfacetFlight():
    ...
    _known = [("2021-05-13_FastScan2_C0039", "C0039_s3m15_d825.MP4.%06d.JPG", "Experiments/2021-05-13_FastScan2/3_Frames/20210513/1210_F03_C0039_s3m15_d825/sony/M4ROOT/CLIP"),
              ("2021-05-13_FastScan2_C0040", "C0040_s1m25_d165.MP4.%06d.JPG", "Experiments/2021-05-13_FastScan2/3_Frames/20210513/1237_F04_C0040_s1m25_d165/sony/M4ROOT/CLIP"),
              ("2021-05-13_FastScan2_C0042", "C0042_s2m05_d920.MP4.%06d.JPG", "Experiments/2021-05-13_FastScan2/3_Frames/20210513/1325_F06_C0042_s2m05_d920/sony/M4ROOT/CLIP"),
              ("2021-05-13_FastScan2_C0043", "C0043_s1m31_d875.MP4.%06d.JPG", "Experiments/2021-05-13_FastScan2/3_Frames/20210513/1410_F07_C0043_s1m31_d875/sony/M4ROOT/CLIP"),
              ("2021-05-13_FastScan2_C0044", "C0044_s2m25_d870.MP4.%06d.JPG", "Experiments/2021-05-13_FastScan2/3_Frames/20210513/1514_F08_C0044_s2m25_d870/sony/M4ROOT/CLIP"),
              ("2021-05-13_FastScan2_C0045", "C0045_s1m50_d880.MP4.%06d.JPG", "Experiments/2021-05-13_FastScan2/3_Frames/20210513/1644_F10_C0045_s1m50_d880/sony/M4ROOT/CLIP"),
              ("2021-05-13_FastScan2_C0046", "C0046_s2m42_d870.MP4.%06d.JPG", "Experiments/2021-05-13_FastScan2/3_Frames/20210513/1720_F11_C0046_s2m42_d870/sony/M4ROOT/CLIP")]
    ...
    def video_dir_name_ext(self, allow_ppt_compressed_videos=False):
        ...
        # check for a similar name
            ...
            if len(matches) == 1:
                ...
                lt.debug(f"In UfacetFlight.video_dir_name_ext(): unable to find a matching video, returning a default value")
    ...
    def num_frames_extracted(self):
        ...
        self._num_frames_extracted = self._count_frames(self.frames_dir_extracted(), self.frames_name_format_extracted())
        return self._num_frames_extracted
    ...
    def num_frames_deduplicated(self):
        ...
        self._num_frames_deduplicated = self._count_frames(self.frames_dir_deduplicated(), self.frames_name_format_deduplicated())
        if self._num_frames_deduplicated == 0:
            ...
            if num_extracted > 0:
                if not self._warned_no_deduplicated_yes_extracted:
                    lt.warn(f"Warning: in UfacetFlight.num_frames_deduplicated(), attempting to access frames for flight {self._name}, which have been extracted but not deduplicated")
    ...
    def results_base_dir(self):
        ...
        if not (("3_Frames" in extracted_dir) and ("sony" in extracted_dir)):
            lt.error_and_raise(ValueError, f"Error: in UfacetFlight.results_base_dir(), unexpected extracted_dir structure for frames: {extracted_dir}")
