...
def construct_raster_survey_scan(solar_field,
                                 scan_segment_spec,
                                 n_horizontal,
                                 n_vertical,
                                 lead_in,
    ...
    # Construct the scan.
    scan = Scan.construct_scan_given_segments_of_interest(scan_segment_spec,
                                                          list_of_xyz_segments,
                                                          lead_in,
                                                          run_past,
                                                          fly_forward_backward)
...
#    aimpoint = [60.0, 8.8, 7]  # For debugging
    ...
    configure_heliostat_name_list = [
                                        '5E4', '6E4', '7E4', '8E4', '9E4', '10E4', '11E4', '12E6', '13E6', '14E6',
                                        '5E5', '6E5', '7E5', '8E5', '9E5', '10E5', '11E5', '12E5', '13E5', '14E5',
                                        '5E6', '6E6', '7E6', '8E6', '9E6', '10E6', '11E6', '12E6', '13E6', '14E6',
                                        '5E7', '6E7', '7E7', '8E7', '9E7', '10E7', '11E7', '12E7', '13E7',
                                        '5E8', '6E8', '7E8', '8E8', '9E8', '10E8', '11E8', '12E8', '13E8',
                                    ]
    ...
    if scan_type == 'UFACET':
        ...
        # Construct the scan.
        scan = construct_raster_survey_scan(solar_field,
                                            scan_segment_spec,
                                            n_horizontal,
                                            n_vertical,
                                            lead_in,
