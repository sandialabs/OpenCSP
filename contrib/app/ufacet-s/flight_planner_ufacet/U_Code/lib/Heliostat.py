...
class Heliostat():
    ...
    def __init__(self, name, origin, num_facets, num_rows=0, num_cols=0,
                 file_centroids_offsets=None, pivot_height=0, pivot_offset=0,
                 facet_width=0, facet_height=0):
        ...
        # Centroid
        self.centroid = [origin[0],
                         origin[1],
                         origin[2] + pivot_offset]  # Origin is at torque tube center.
        ...
        with open(file) as csvfile:
            ...
            for row in readCSV:
                ...
                facet = Facet(name=name, centroid_offset=[x, y, z],
                              width=self.facet_width, height=self.facet_height)
