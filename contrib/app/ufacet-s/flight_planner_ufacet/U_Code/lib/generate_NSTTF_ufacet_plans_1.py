...
def generate_NSTTF_ufacet_plans(solar_field_short_name, nsttf_configuration, elevation_offset, save_flight_plan, save_figures):
    # Figure layout.
#    tile_array=(2,2)
    tile_array=(1,1)
#    tile_array=(2,1)
...
#    render_control_scan_section_analysis = drc.setup_render_control_scan_section_analysis_flight_4view()
    ...
    if solar_field_short_name == 'NSTTF':
        ...
        synch_azelhnames,          \
        up_azelhnames = dsn.define_scan_NSTTF(solar_field_short_name, nsttf_configuration)
    ...
    if nsttf_configuration == 'Full Field':
        ...
        print('ERROR: In generate_NSTTF_ufacet_plans(), unexpected nsttf_configuration="'+str(nsttf_configuration)+'" encountered.')
        assert False
