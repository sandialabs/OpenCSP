...
def ideal_gaze_xy_list(aimpoint_xyz, 
                       field_origin_lon_lat,
                       when_ymdhmsz,
                       key_xy, 
                       integration_step,
                       bbox_xy):  # Integration limits.
    # Integrate forward from the key point.
    post_x_list, post_y_list = ideal_gaze_xy_list_aux(aimpoint_xyz, 
                                                      field_origin_lon_lat,
                                                      when_ymdhmsz,
                                                      key_xy,
                                                      integration_step,
    ...
    pre_x_list, pre_y_list = ideal_gaze_xy_list_aux(aimpoint_xyz, 
                                                    field_origin_lon_lat,
                                                    when_ymdhmsz,
                                                    key_xy,
...
def ideal_gaze_xy_list_aux(aimpoint_xyz, 
                           field_origin_lon_lat,
                           when_ymdhmsz,
                           key_xy,
                           integration_step,
...
def ufacet_xy_analysis(solar_field, aimpoint_xyz, when_ymdhmsz, curve_key_xy_list):
    ...
    for key_xy in curve_key_xy_list:
        ...
        ideal_xy_list = ideal_gaze_xy_list(aimpoint_xyz, 
                                           field_origin_lon_lat,
                                           when_ymdhmsz,
                                           key_xy, 
                                           integration_step,
