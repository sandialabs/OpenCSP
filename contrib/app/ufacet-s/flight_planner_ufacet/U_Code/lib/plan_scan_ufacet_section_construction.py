...
def heliostat_name_pqw_list_within_margin(
...
def construct_ufacet_section(solar_field, best_fit_segment_xy, ufacet_scan_parameters):
    ...
    candidate_heliostat_name_list = [
        name_pqw[0] for name_pqw in candidate_heliostat_name_pqw_list
    ]
    selected_heliostat_name_list = [
        name_pqw[0] for name_pqw in selected_heliostat_name_pqw_list
    ]
    rejected_heliostat_name_list = [
        name_pqw[0] for name_pqw in rejected_heliostat_name_pqw_list
    ]
    # Store results.
    section = {}
...
def construct_ufacet_sections(
    ...
    for best_fit_segment_xy in list_of_best_fit_segment_xys:
        section = construct_ufacet_section(
            solar_field, best_fit_segment_xy, ufacet_scan_parameters
        )
