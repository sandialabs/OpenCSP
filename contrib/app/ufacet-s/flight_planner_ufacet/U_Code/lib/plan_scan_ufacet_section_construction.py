...
def select_min_w_reject_nearby_p_aux(selected_heliostat_name_pqw_list,
    ...
    if len(remaining_heliostat_name_pqw_list) == 0:
        ...
        return selected_heliostat_name_pqw_list,  \
                rejected_heliostat_name_pqw_list,  \
                remaining_heliostat_name_pqw_list
    else:
        ...
        for name_pqw in remaining_heliostat_name_pqw_list:
            this_p = p(name_pqw)
        return select_min_w_reject_nearby_p_aux(selected_heliostat_name_pqw_list,
                                                 rejected_heliostat_name_pqw_list,
                                                 new_remaining_heliostat_name_pqw_list,
                                                 discard_threshold_p)
...
def select_min_w_reject_nearby_p(candidate_heliostat_name_pqw_list, ufacet_scan_parameters):
    ...
    selected_heliostat_name_pqw_list,  \
    rejected_heliostat_name_pqw_list,  \
    remaining_heliostat_name_pqw_list = select_min_w_reject_nearby_p_aux(selected_heliostat_name_pqw_list,
                                                                         rejected_heliostat_name_pqw_list,
                                                                         remaining_heliostat_name_pqw_list,
                                                                         discard_threshold_p)
    # Return.
...
def construct_ufacet_section(solar_field, best_fit_segment_xy, ufacet_scan_parameters):
    ...
    candidate_heliostat_name_pqw_list = heliostat_name_pqw_list_within_margin(solar_field,
                                                                              section_view_spec,
    ...
    selected_heliostat_name_pqw_list,  \
    rejected_heliostat_name_pqw_list = select_min_w_reject_nearby_p(candidate_heliostat_name_pqw_list, ufacet_scan_parameters)
