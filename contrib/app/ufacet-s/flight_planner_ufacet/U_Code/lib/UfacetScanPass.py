...
class UfacetScanPass():
    ...
    def __init__(self,
                 ...
                 ufacet_scan_parameters):  # Dictionary containing control information.
        ...
        self.pass_constraints = psusa.section_analysis(self.section_context,
                                                       self.heliostat_name_list,
                                                       self.assess_heliostat_name_list)
    ...
    def setup_section(self):
        ...
        self.section_context['view_spec'] = self.section['view_spec']  # ?? SCAFFOLDING RCB -- ELIMINATE DUPLICATION, CONFUSION.
    ...
    def waypoints(self):
        ...
        if gaze_type == 'constant':
            # Constant gaze.
            selected_cacg_etaC = self.pass_constraints['selected_cacg_etaC'] # "cacg" == "constant altitude, constant gaze"
        ...
        print('WARNING: In UfacetScanPass.waypoints(), speed calculation not implemented yet. Setting speed to ' + str(speed) + ' m/sec.')# ?? RCB SCAFFOLDING -- STUB
    ...
    def draw_section_analysis(self, figure_control, analysis_render_control):
        psusar.draw_section_analysis(figure_control,
