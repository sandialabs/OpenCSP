...
def construct_scan_parameters(scan_parameter_file):
    ...
    if scan_parameter_file == 'NSTTF':
        ...
        # Location.
        scan_parameters['locale'] = 'NSTTF' # Information needed to convert (x,y,z into global (longitude, latitude) coordinates.
...
# scan_parameters['camera'] = cam.mavic_zoom()  # Camera model.
      ...
      print("ERROR: In construct_scan_parameters(), unexpected scan_parameter_file = '"  + scan_parameter_file + "' encountered.")
      assert False
