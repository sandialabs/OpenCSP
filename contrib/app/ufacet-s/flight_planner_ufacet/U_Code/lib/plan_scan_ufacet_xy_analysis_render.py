...
def draw_ufacet_xy_analysis(figure_control,
                            solar_field,
                            aimpoint_xyz,
    ...
    if render_control_scan_xy_analysis.draw_xy_segment_analysis:
        ...
        grid_xydxy = [[p, sun_track.tracking_surface_normal_xy(p+[0], aimpoint_xyz, field_origin_lon_lat, when_ymdhmsz)] for p in grid_xy]
