...
def construct_ufacet_scan(solar_field, 
                          aimpoint_xyz,
                          when_ymdhmsz,
    ...
    ufacet_scan_parameters = psup.construct_ufacet_scan_parameters(ufacet_scan_parameter_file, ufacet_control_parameters)
    ...
    list_of_best_fit_segment_xys = psuxya.ufacet_xy_analysis(solar_field, aimpoint_xyz, when_ymdhmsz, curve_key_xy_list)

    # UFACET section analysis.
    section_list = psusc.construct_ufacet_sections(solar_field, 
