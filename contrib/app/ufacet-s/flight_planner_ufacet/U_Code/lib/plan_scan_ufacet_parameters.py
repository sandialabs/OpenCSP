...
def construct_ufacet_scan_parameters(ufacet_scan_parameter_file, ufacet_control_parameters):
    ...
    if ufacet_scan_parameter_file == 'NSTTF':
        ...
        scan_parameters['candidate_margin_w']  = 10.00  # m.  Margin on either side of section plane to bring in heliostats.
                                                        #     Should be larger than side-to-side heliostat distance.
        scan_parameters['discard_threshold_p'] =  9.00  # m.  Threshold to discard heliostats that are close together on a section, presumably abreast.
        ...
        scan_parameters['maximum_safe_altitude']   = 90.0 # meters.  Driven by safey considerations.  Control limit may be tighter.
        ...
        if scan_parameters['maximum_altitude'] > scan_parameters['maximum_safe_altitude']:
            print('NOTE: In construct_ufacet_scan_parameters(), input maximum altitude = '
      ...
      print("ERROR: In construct_ufacet_scan_parameters(), unexpected ufacet_scan_parameter_file = '"  + ufacet_scan_parameter_file + "' encountered.")
      assert False
