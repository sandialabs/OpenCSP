...
class ExampleMirrorOutput(to.TestOutput):
    ...
    def setUpClass(
        ...
        # Generic setup.
        super(ExampleMirrorOutput, cls).setUpClass(
    ...
    def example_mirror(self) -> None:
        ...
        fig_record = fm.setup_figure_for_3d_data(
            ...
            title=self.m1_title + ', Face Up',
            caption=st.add_to_last_sentence(self.m1_caption, ', face up'),
    ...
    def example_solar_field(self) -> None:
        ...
        facet_ensemble_control = rcfe.RenderControlFacetEnsemble(
            default_style=facet_control, draw_outline=True, draw_centroid=True
        )
        heliostat_control = rch.RenderControlHeliostat(
            draw_centroid=True, facet_ensemble_style=facet_ensemble_control, draw_facet_ensemble=True
        )
    ...
    def example_heliostat_05W01_and_14W01(self) -> None:
        ...
        fig_record.z_limits = (
            exaggerated_z_limits_5W01  # Limits are on z values, even though the plot is 2-d.  View3d.py handles this.
        )
        h_5W01.draw(fig_record.view, heliostat_control_exaggerated_z)
        self.show_save_and_check_figure(fig_record)
