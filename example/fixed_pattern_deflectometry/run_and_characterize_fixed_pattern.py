...
def process(fixed_pattern_dot_locs: FixedPatternDotLocations,
...
def run() -> None:
    ...
    file_fixed_pattern_dot = os.path.join(dir_calibration, "fixed_pattern_display_w3_s6.h5")
    file_spatial_orientation = os.path.join(dir_calibration, "fixed_pattern_display_w3_s6.h5")
    file_facet_data = os.path.join(dir_calibration, "Facet_NSTTF.json")
    file_image_projection = os.path.join(dir_calibration, 'Image_Projection_optics_lab_landscape_square.h5')
    ...
    fixed_pattern = FixedPatternScreenProjection(image_projection.size_x, image_projection.size_y, width_pattern=3, spacing_pattern=6)
    ...
    fixed_pattern_dot_locs = FixedPatternDotLocations.load_from_hdf(file_fixed_pattern_dot)
    ...
    def run_next():
        ...
        if resp == 'm':
            ...
            # Process
            measurement = FixedPatternMeasurement(frame, v_measure_point_facet, dist_optic_screen, pt_origin, name='NSTTF Facet')
