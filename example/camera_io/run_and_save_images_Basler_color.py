...
def main():
    ...
    parser.add_argument('camera_index', type=int, help='Camera index (0-indexed in order of camera serial number) to run.')
    ...
    parser.add_argument('-p', '--prefix', metavar='prefix', default='', type=str, help='Image save prefix to be appended before the filename.')
