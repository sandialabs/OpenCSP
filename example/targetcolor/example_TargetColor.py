...
class ExampleTargetColor(to.TestOutput):
    ...
    def setup_class(self,
                    ...
                    verify:bool=True):
        # Generic setup.
        super(ExampleTargetColor, self).setup_class(source_file_body=source_file_body,
...
# self.image_height_in = 5.0 # 96.0 # inch
    ...
    def execute_example_linear_color_bar(self, color_below_min:Color, color_bar, color_bar_name:str, color_above_max:Color, generate_all:bool) -> None:
        if generate_all:
            # Linear color bar in x, discrete.
            target = tc.construct_target_linear_color_bar(self.image_width, self.image_height, self.dpm,
                                                        color_below_min, color_bar, color_bar_name, color_above_max, 'x', 'discrete')
        ...
        if generate_all:
            ...
            target = tc.construct_target_linear_color_bar(self.image_width, self.image_height, self.dpm,
                                                        color_below_min, color_bar, color_bar_name, color_above_max, 'y', 'continuous')
            self.save_and_check_image(target.image, self.dpm, target.description_inch(), '.png')


    # ?? SCAFFOLDING RCB -- ADD COLOR_BAR TYPE TIP BELOW
    def execute_example_polar_color_bar(self, color_below_min:Color, color_bar, color_bar_name:str, color_above_max:Color) -> None:
        # Default.
    ...
    def execute_example_extend_target(self) -> None:
        ...
        extended_target_left_right_top = tc.extend_target_top(extended_target_left_right, top_pixels, Color.light_grey())
        ...
        extended_target_left_right_top_bottom = tc.extend_target_bottom(extended_target_left_right_top, bottom_pixels, Color.dark_grey())
        ...
        extended_target_left_right_top_bottom_border = tc.extend_target_all(extended_target_left_right_top_bottom, border_pixels, Color.magenta())
