...
class ExampleTargetColor(to.TestOutput):
    ...
    def execute_example_adjust_color_saturation(
        self, saturation_fraction: float
    ) -> None:
        # Construct target.
        target = tc.construct_target_blue_under_red_cross_green(
            self.image_width, self.image_height, self.dpm
        ...
        print(
            'WARNING:  In execute_example_adjust_color_saturation(), saturation adjustment not implemented yet.'
        )
        # Save and check.
        self.save_and_check_image(
            target.image, self.dpm, target.description_inch(), '.png'
    ...
    def execute_example_extend_target(self) -> None:
        ...
        extended_target_left_right = tc.extend_target_right(
            extended_target_left, right_pixels, Color.grey()
        )
    ...
    def example_matlab(self) -> None:
        ...
        color_above_max = Color.white()  # White background for "saturated data."
        self.execute_example_linear_color_bar(
    ...
    def example_polar_color_bar(self) -> None:
        ...
        color_bar_name = 'O'  # ?? SCAFFOLDING RCB -- THIS SHOULD BE A CLASS MEMBER
        color_above_max = Color.white()  # White background for "saturated data."
        self.execute_example_polar_color_bar(
