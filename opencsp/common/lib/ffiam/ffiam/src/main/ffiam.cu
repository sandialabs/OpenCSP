                          ...
                          bool useCpu)
{
    ...
    {
        Log("Facet data file not provided. Will compute facet origins from data.");
    }
...
int main()
{
    ...
    const int status = InitPresetAnalysis(arena, nMemory, voxelArena, nVoxelMemory,
                                          datetime, site_crescentDunes, aim_point,
                                          aimParams, true, 3);
