"""Example analyses for preset sites (NSTTF, Crescent Dunes, SampleV2)."""
...
def assess_crescent_dunes_small():
    result = analysis(site=CspSite.CrescentDunesSmall,
                      year=2025,
                      month=6,
                      day=21,
                      hour=12,
...
def assess_nsttf():
    preset_result = analysis(site=CspSite.NSTTF,
                             threshold=2,
                             create_gifs=False,
                             create_xls=True,
                             aim_strat=AimType.Point,
                             ...
                             paths=[
                                 [(-150, 100, 60), (-105, 40, 50), (-100, 40, 50),
                                  (-60, 60, 47),
                                  (-5, 152, 40), (0, 150, 40),
                                  (25, 75, 55),
                                  (50, 50, 60), (53, 52, 62),
...
def assess_sample_v2():
    result = analysis(site=CspSite.SampleV2,
                      year=2024,
                      month=6,
                      day=21,
                      hour=12,
...
if __name__ == "__main__":
    assess_crescent_dunes()
    # assess_crescent_dunes_small()
    # assess_nsttf()
    # assess_sample_v2()
