...
_SITE_MAPPINGS: dict[str, CspSite] = {
    'nsttf': CspSite.NSTTF,
    'crescentdunessm': CspSite.CrescentDunesSmall,
    'crescentdunessmall': CspSite.CrescentDunesSmall,
    'crescentdunes': CspSite.CrescentDunes,
    'crescent dunes': CspSite.CrescentDunes,
...
def get_csp_site_from_string(site_str: str, strict: bool = False) -> CspSite:
    ...
    elif 'crescent' in site_lower and 'sm' in site_lower:
        return CspSite.CrescentDunesSmall
    elif 'crescent' in site_lower:
        return CspSite.CrescentDunes
