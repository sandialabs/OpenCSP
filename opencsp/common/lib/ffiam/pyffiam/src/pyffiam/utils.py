...
from pyffiam.ffiam_types import CspSite, get_csp_site_from_string, get_aim_type_from_string
...
def load_preset_sites_from_json() -> Dict[CspSite, Dict[str, Any]]:
    ...
    preset_files = {
        ...
        CspSite.CrescentDunesSmall: 'CrescentDunesSm.json',
        CspSite.CrescentDunes: 'CrescentDunes.json',
