...
class TestDisplay:
    ...
    def setup_class(cls):
        ...
        # Define test points
        cls.test_Vxy_pts = Vxy(([0, 0.5, 1, 0, 0.5, 1, 0, 0.5, 1],
        ...
        cls.grid_data_2D = {
            ...
            'Pxy_screen_coords': Vxy(([-LX / 2, LX / 2, -LX / 2, LX / 2],
                                      [-LY / 2, -LY / 2, LY / 2, LY / 2])),
        ...
        cls.grid_data_3D = {
            'Pxy_screen_fraction': Vxy(([0, 1, 0, 1], [0, 0, 1, 1])),
            'Pxyz_screen_coords': Vxyz(([-LX / 2, LX / 2, -LX / 2, LX / 2],
                                        [-LY / 2, -LY / 2, LY / 2, LY / 2],
                                        [LZ, LZ, 0, 0])),
        ...
        cls.exp_Vxy_disp_pts = Vxyz(([-LX / 2, 0., LX / 2, -LX / 2, 0., LX / 2, -LX / 2, 0., LX / 2],
                                     [-LY / 2, -LY / 2, -LY / 2, 0., 0., 0., LY / 2, LY / 2, LY / 2],
                                     [0., 0., 0., 0., 0., 0., 0., 0., 0.]))

        # Define expected 3D points
        cls.exp_Vxyz_disp_pts = Vxyz(([-LX / 2, 0., LX / 2, -LX / 2, 0., LX / 2, -LX / 2, 0., LX / 2],
                                      [-LY / 2, -LY / 2, -LY / 2, 0., 0., 0., LY / 2, LY / 2, LY / 2],
                                      [LZ, LZ, LZ, LZ / 2, LZ / 2, LZ / 2, 0., 0., 0.]))

    def test_rectangular2D(self):
        # Instantiate display object
        V_cam_screen_screen = Vxyz((0, 0, 1))
        R_screen_cam = Rotation.from_rotvec(np.array([0., 0., 0.]))
        name = 'Test Display'
