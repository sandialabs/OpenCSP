...
class Surface2DParabolic(Surface2DAbstract):
    def __init__(self,
        ...
        self.surf_coefs = np.array([0, 0, 1 / 4 / initial_focal_lengths_xy[0], 0, 0, 1 / 4 / initial_focal_lengths_xy[1]], dtype=float)
    ...
    def normal_fit_at_align_point(self) -> Vxyz:
        ...
        """
        dzdx_meas = -(self.slope_coefs[0, 1] * self.v_align_point_optic.x[0] + self.slope_coefs[0, 0] + self.slope_coefs[1, 2] * self.v_align_point_optic.x[0])
        dzdy_meas = -(self.slope_coefs[1, 2] * self.v_align_point_optic.y[0] + self.slope_coefs[1, 0] + self.slope_coefs[1, 1] * self.v_align_point_optic.y[0])
