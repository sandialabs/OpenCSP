...
def test_bundle_adjust_points():
    ...
    rvecs_out, tvecs_out, pts_obj_out = ba.bundle_adjust(rvecs_in, tvecs_in, pts_obj, cam_indices, point_indices, pts_img, int_mat, dist_coefs, 'points', verbose=True)
...
def test_bundle_adjust_camera():
    ...
    rvecs_out, tvecs_out, pts_obj_out = ba.bundle_adjust(rvecs_in, tvecs_in, pts_obj, cam_indices, point_indices, pts_img, int_mat, dist_coefs, 'camera', verbose=True)
