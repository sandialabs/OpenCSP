...
@unittest.mock.patch.dict(os.environ, {"OPENCSP_SETTINGS_DIRS": "None"})  # don't run unit tests with user specific settings
    ...
    def test_settings_file(self):
        ...
        if os.path.exists(self.tmp_settings_file):
            ...
            if file_contents.strip() != self.tmp_settings_contents:
                self.skipTest(f"File '{self.tmp_settings_file}' already exists. Not replacing file with a testing file.")
