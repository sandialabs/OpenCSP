...
class TestSubprocess(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.src_img_dir = os.path.join(orp.opencsp_code_dir(), 'common', 'lib', 'cv', 'test', 'data', 'input', 'OpticalFlow')
        cls.dst_dir = os.path.join(orp.opencsp_code_dir(), 'common', 'lib', 'cv', 'test', 'data', 'output', 'OpticalFlow')
    ...
    def _prep_ref_img(self, travel: int, frame_motion_dir="up", secondary_frame_motion_dir=None):
        ...
        for motion in motions:
            if motion == "up":
                translated_crop = (translated_crop[0], translated_crop[1]-tv, translated_crop[2], translated_crop[3]-tv)
            elif motion == "down":
                translated_crop = (translated_crop[0], translated_crop[1]+tv, translated_crop[2], translated_crop[3]+tv)
            elif motion == "right":
                translated_crop = (translated_crop[0]+tv, translated_crop[1], translated_crop[2]+tv, translated_crop[3])
            elif motion == "left":
                translated_crop = (translated_crop[0]-tv, translated_crop[1], translated_crop[2]-tv, translated_crop[3])
    ...
    def test_left(self):
        ...
        Image.fromarray(flow.to_img()).save(os.path.join(self.dst_dir, "frame_translate_left__image_data_translate_right.jpg"))
    ...
    def test_left_down(self):
        ...
        # bonus test! can we save without error?
        Image.fromarray(flow.to_img()).save(os.path.join(self.dst_dir, "frame_translate_left_down__image_data_translate_right_up.jpg"))
    ...
    def test_down(self):
        ...
        # bonus test! can we save without error?
        Image.fromarray(flow.to_img()).save(os.path.join(self.dst_dir, "frame_translate_down__image_data_translate_up.jpg"))
    ...
    def test_right(self):
        ...
        # bonus test! can we save without error?
        Image.fromarray(flow.to_img()).save(os.path.join(self.dst_dir, "frame_translate_right__image_data_translate_left.jpg"))
    ...
    def test_up(self):
        ...
        # bonus test! can we save without error?
        Image.fromarray(flow.to_img()).save(os.path.join(self.dst_dir, "frame_translate_up__image_data_translate_down.jpg"))
