...
class TestRayTraceOutput(to.TestOutput):
    ...
    def setup_class(self,
                    ...
                    verify: bool = True):
        # Generic setup.
        super(TestRayTraceOutput, self).setup_class(source_file_body=source_file_body,
    ...
    def test_partial_field_trace(self) -> None:
        ...
        heliostat_list = ['5E10','5E9','5E8','5E7','5E6','5E5','5E4','5E3','5E2','5E1','5W1','5W2','5W3','5W4','5W5']
