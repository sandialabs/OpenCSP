...
class TestMotionBasedCanting(to.TestOutput):
    ...
    def setup_class(self, 
        ...
        self.solar_field:SolarField = sf.sf_from_csv_files(name='Sandia NSTTF',
                                                           short_name='NSTTF',
    ...
    def projected_facet_normal_intersection_point_offset(self, target_loc:'Pxyz', target_plane_normal:'Uxyz', heliostat_name: str, f_index: int, az: float, el: float): 
        """
        ...
        test_configuration = hc.HeliostatConfiguration(az, el)
        ...
        facet = heliostat.facets[heliostat.facet_dict[str(f_index)]]
    ...
    def azimuth_binary_search(self, target_loc:'Pxyz', target_plane_normal:'Uxyz', heliostat_name:str, f_index:int, az:float, el:float, tolerance:float):
        """
        ...
        is_intersect, offset_x, offset_z, intersection = self.projected_facet_normal_intersection_point_offset(target_loc, target_plane_normal, heliostat_name, f_index, az, el)
    ...
    def elevation_binary_search(self, target_loc:'Pxyz', target_plane_normal:'Uxyz', heliostat_name:str, f_index:int, az:float, el:float, tolerance:float):
        """
...
.       target_loc: xyz location of target on given plane
        ...
        # heliostat selection index
        heliostat_id = solar_field.heliostat_dict[heliostat_name] 
        heliostat = solar_field.heliostats[heliostat_id] 
        ...
        is_intersect, offset_x, offset_z, intersection_point = self.projected_facet_normal_intersection_point_offset(target_loc, target_plane_normal, heliostat_name, f_index_temp, az, el)
    ...
    def test_9W1_heliostat(self) -> None:
        ...
        # Heliostat selection
        heliostat_name = '9W1'
        up_heliostats   = ['9W2', '9W3', '9E1', '9E2', '8W2', '8W1', '8E1', '8E2',
                               '10W2', '10W1', '10E1', '10E2']
        test_heliostat = [heliostat_name]
        ...
        #heliostat selection index
        H_9W1_INDEX = 87
        h_9W1 = solar_field.heliostats[H_9W1_INDEX]
        ...
        #shows all facet intersection points
        for f_index, facet in enumerate(h_9W1.facets):
            facet_origins.append(facet.origin)
            facet_normals.append(facet.surface_normal)
        ...
        surface_normal_facet_style.facet_styles.default_style.surface_normal_length=300
        solar_field_style = rcsf.heliostat_blanks()
        solar_field_style.heliostat_styles.add_special_names(up_heliostats, rch.facet_outlines(color='g'))
        ...
        fig_record = fm.setup_figure_for_3d_data(self.figure_control, self.axis_control_m, vs.view_spec_3d(),number_in_name=False,
                                                input_prefix=self.figure_prefix(f_index), # Figure numbers needed because titles may be identical. Hard-code number because test order is unpredictable.
    ...
    def test_azimuth_binary_search(self) -> None:
        ...
        # Comment
        comments.append("The tower with a target in red and intersection points in blue from the surface normal of the facet.")
    ...
    def test_single_facet(self) -> None:
        ...
        #style setup
        surface_normal_facet_style = rch.normal_facet_outlines()
        surface_normal_facet_style.facet_styles.add_special_names([int(f_index)], rcf.normal_outline_long(color='b'))
        solar_field_style = rcsf.heliostat_blanks()
        solar_field_style.heliostat_styles.add_special_names(test_heliostat, surface_normal_facet_style)
        tower_control = rct.normal_tower()
    ...
    def test_all_facets(self) -> None:
        ...
        for f_index, f_index in enumerate(heliostat.facet_dict):
            ...
            caption = 'A single Sandia NSTTF heliostat ' + heliostat_name + ', with facet ' + '{0:02d}'.format(int(f_index))
            comments = []
