...
class Tower(RayTraceable):
    ...
    def __init__(self, name: str, 
        ...
        self.top = [[self.east, self.north, self.height], [self.west, self.north, self.height], [self.west, self.south, self.height], [self.east, self.south, self.height]]
        self.northface = [[self.east, self.north, self.height], [self.west, self.north, self.height], [self.west, self.north, 0], [self.east, self.north, 0]]
        self.southface = [[self.east, self.south, self.height], [self.west, self.south, self.height], [self.west, self.south, 0], [self.east, self.south, 0]]
        self.bottom = [[self.east, self.north, 0], [self.west, self.north, 0], [self.west, self.south, 0], [self.east, self.south, 0]]
...
# surface_normal = hel_rotation.dot([0, 0, 1])  # Before rotation, heliostat is face up.
    ...
    def draw(self, view: View3d, tower_style:RenderControlTower)-> None:
        ...
        #Whole tower
        if 'whole tower' in self.parts: self.parts += ['top', 'northface', 'southface', 'northface', 'bottom']
