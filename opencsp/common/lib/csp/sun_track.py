...
@strict_types
def tracking_surface_normal_xyz(heliostat_xyz: list | np.ndarray | tuple,     # (x,y,z) in m.     Heliostat origin.
                                ...
                                when_ymdhmsz: list | np.ndarray | tuple):     # (year, month, day, hour, minute, second, timezone) tuple.
    #  Example: (2022, 7, 4, 11, 20, 0, -6)
    #              => July 4, 2022 at 11:20 am MDT (-6 hours)
    """
    Computes heliostat surface normal which tracks the sun to the aimpoint.
