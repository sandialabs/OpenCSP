...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        ...
        description = 'Tests the subprocess tools.')
    ...
    parser.add_argument('--mixed_stdout_stderr', action='store_true', help="Outputs 'foo', 'bar', and 'baz' on stdout, stderr, and stdout, respectively.")
