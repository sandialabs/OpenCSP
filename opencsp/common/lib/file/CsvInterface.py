...
class CsvInterface():
    ...
    def to_csv(self, description: str, file_path: str, file_name: str, error_if_dir_not_exist: bool = True, rows: Optional[list["CsvInterface"]] = None):
        ...
        ft.to_csv(description, file_path, file_name, error_if_dir_not_exist=error_if_dir_not_exist,
                  heading_line=header_str, data_lines=row_strs)
