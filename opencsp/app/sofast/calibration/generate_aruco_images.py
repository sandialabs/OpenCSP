...
def main():
    ...
    parser.add_argument('number', type=int, help='Number of images to generate (1-1000).')
    parser.add_argument('-s', '--size', metavar='size', default=500, type=int, help='Side length in pixels of generated images not including padding (default=500).')
    parser.add_argument('-p', '--padding', metavar='padding', default=50, type=int, help='Size of white border to pad image in pixels (default=50)')
