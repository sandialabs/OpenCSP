...
def downsample_dataset(dir_input: str, dir_output: str) -> None:
    ...
    camera_sofast_ds = dd.downsample_camera(join(dir_input, 'camera_screen_shape.h5'), n_sofast)
    camera_sofast_ds.save_to_hdf(join(dir_output, 'camera_screen_shape.h5'))


if __name__ == '__main__':
    downsample_dataset(
        dir_input=join(os.path.dirname(opencsp.__file__), '../../sample_data/sofast/data_photogrammetric_calibration/data_measurement'),
